...
const FindPassword = () => {
  ...
  const handleClick = async () => {
    if (user.email === "") {
      ...
      // 백엔드로 요청 전송
      const url =
        "http://ec2-3-38-101-203.ap-northeast-2.compute.amazonaws.com/account/findpassword";
      const payload = {
        email: user.email,
          ...
          <Div>
            <FormDiv>
              ...
              <Input
                type="text"
                name="username"
                placeholder="가입한 username을 입력해주세요"
                onChange={handleuser}
                ref={usernameRef}
              />
              <MsgDiv>
